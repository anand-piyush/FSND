...
AUTH0_DOMAIN = 'iamgmt.eu.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'coffeehouseudacity'
...
def check_permissions(permission, payload):
    """
    raise an AuthError if permissions are not included 
    in the payload
    !!NOTE (Done) check your RBAC settings in Auth0 
...
def verify_decode_jwt(token):
    ...
    args :: token: a json web token (string)
...
def requires_auth(permission=''):
    ...
    args:: permission: string permission (i.e. 'post:drink')
