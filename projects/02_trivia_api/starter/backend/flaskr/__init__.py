...
def create_app(test_config=None):
    ...
    # TODo Done : COMMENT OR DELETE THE BELOW METHOD
    ...
    def after_request(response):
        ...
        response.headers.add(header_name, 'GET, POST, PATCH, DELETE, OPTION')
        return response
    ...
    def add_question():
        ...
        if searchTerm is given, a POST endpoint to get questions
        ...
        if "searchTerm" in form_data:
            ...
            if (form_data['question'].strip() == "") or \
            ...
            try:
                ...
                new_question = Question(question=ques, answer=ans,
    ...
    def quiz():
        ...
        questions = Question.query.filter_by(
          category=str(request_cat)).all() \
            if request_cat else Question.query.all()
